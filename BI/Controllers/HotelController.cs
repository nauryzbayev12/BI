...
namespace BI.Controllers
{
    ...
    public class HotelController : ControllerBase
    {
        ...
        {
            var hotels = await _unitOfWork.Projects.GetPagedList(requestParams);
        ...
        {
            var hotel = await _unitOfWork.Projects.Get(q => q.Id == id);
        ...
        public async Task<IActionResult> CreateHotel([FromBody] CreateHotelDTO hotelDTO)
        {
            ...
            var hotel = _mapper.Map<Project>(hotelDTO);
            await _unitOfWork.Projects.Insert(hotel);
        ...
        public async Task<IActionResult> UpdateHotel(int id, [FromBody] UpdateHotelDTO hotelDTO)
        {
            ...
            _unitOfWork.Projects.Update(hotel);
            await _unitOfWork.Save();
