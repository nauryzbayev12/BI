...
namespace BI.API
{
    public static class ServiceExtensions
    {
        public static void ConfigureIdentity(this IServiceCollection services)
        {
            ...
            builder.AddTokenProvider("BIApi", typeof(DataProtectorTokenProvider<ApplicationUser>));
        ...
        public static void ConfigureSwaggerDoc(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Description = @"Пример: Bearer 12345abcdefasdgadsfdasfdsafdsfasdsfafdsfafsdfafasd",
                    Name = "Authorization",
